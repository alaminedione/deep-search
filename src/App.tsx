  ...
  return (
    <>
      ...
      <div className="options flex flex-col gap-3">
        <InputTags id='websites' placeholder='sur quels websites ou noms de domaines tu veux faire les recherches' tags={TagsSites} setTags={setExampleTagsSites} />
        <InputTags id='site-toExclude' placeholder='ajouter des sites a exclure  ' tags={TagsSitesToExclude} setTags={setExampleTagsSitesToExclude} />
        <InputTags id='word-toExclude' placeholder='ajouter des mots a exclure' tags={TagsWords} setTags={setExampleTagsWords} />
        <InputTags id='filetypes' placeholder="types de fichier example: pdf, docx, mp4, png" tags={TagsFileType} setTags={setExampleTagsFileType} />
        <InputTags id="intitle" placeholder="mots qui doivent apparaître dans le titre" tags={TagsWordsInTitle} setTags={setExampleTagsWordsInTitle} />
        <InputTags id="inurl" placeholder="mots qui doivent apparaître dans l'url" tags={TagsWordsInUrl} setTags={setExampleTagsWordsInUrl} />

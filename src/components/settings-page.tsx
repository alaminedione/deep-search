...
export const SettingsPage = forwardRef<HTMLDivElement, SettingsPageProps>(
  ({ searchEngine, setSearchEngine, open, onOpenChange }) => {
    ...
    useEffect(() => {
      ...
      const storedCacheEnabled = localStorage.getItem(
        "deepSearch_cacheEnabled",
      );
          ...
          <div className="grid gap-6 py-4">
            ...
            <Card className="border-2 border-dashed border-primary/20 bg-gradient-to-br from-primary/5 to-secondary/5">
              <CardHeader>
                ...
                <CardDescription>
                  Configurez votre API pour utiliser les fonctionnalités
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={localProvider}
                    onValueChange={(value) =>
                      setLocalProvider(value as AIProvider)
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configurez votre moteur de recherche et les options de
                  recherche
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleAdvancedSettingChange("autoSave", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleAdvancedSettingChange("cacheEnabled", checked)
                    }
                  />
                </div>
              ...
              <CardContent className="space-y-2">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    {searchEngine === "google.com" ? "Google" : "DuckDuckGo"}
                  </div>
                </div>
              </CardContent>
            </Card>
